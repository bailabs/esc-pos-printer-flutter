package com.example.escpos_usb_printer;
...
/**
 * EscposUsbPrinterPlugin
 */
public class EscposUsbPrinterPlugin implements FlutterPlugin, MethodCallHandler {
    ...
    private static com.example.escpos_usb_printer.USBPrinterAdapter adapter;

    @Override
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "escpos_usb_printer");
